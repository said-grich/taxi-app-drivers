...
class PushNotificationService{
  ...
  Future initialize(context) async {
    ...
    print("Notification initialize is Called");
    ...
    fcm.configure(
      ...
      onMessage: (Map<String, dynamic> message) async {
        ...
        print("On Message is Working : $message");

        fetchRideInfo(getRideID(message), context);
      },
      onLaunch: (Map<String, dynamic> message) async {

        print("On Launch is Working : $message");
      ...
      onResume: (Map<String, dynamic> message) async {
        ...
        print("On Resume is Working : $message");
  ...
  Future<String> getToken() async{
    ...
    DatabaseReference tokenRef = FirebaseDatabase.instance.reference().child('driver_users/${currentFirebaseUser.currentUser.uid}/token');
    tokenRef.set(token);
  ...
  void fetchRideInfo(String rideID, context){
    ...
    print("Fetch Ride Info is Called");
    ...
    rideRef.once().then((DataSnapshot snapshot){
      ...
      if(snapshot.value != null){
        ...
        String personNumber = snapshot.value['person_number'];
        String riderPhoto = snapshot.value['rider_Photo'];
        String tripCost = snapshot.value['tripCost'];
        ...
        tripDetails.personNumber = personNumber;
        tripDetails.riderPhoto = riderPhoto;
        tripDetails.tripCost = tripCost;
