...
class HelperMethods{
  ...
  static void getCurrentUserInfo() async{
    ...
    DatabaseReference userRef = FirebaseDatabase.instance.reference().child('driver_users/$userid');
  ...
  static void getHistoryInfo (context){
    ...
    DatabaseReference earningRef = FirebaseDatabase.instance.reference().child('driver_users/${currentFirebaseUser.currentUser.uid}/earnings');
    ...
    DatabaseReference historyRef = FirebaseDatabase.instance.reference().child('driver_users/${currentFirebaseUser.currentUser.uid}/history');
